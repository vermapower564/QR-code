...
<div class="min-h-[60vh] flex flex-col items-center justify-center text-center p-6">
    ...
    <h2 class="text-2xl font-bold text-slate-900">403 - Access Forbidden</h2>
    <p class="text-slate-600 mt-2 max-w-md">This profile is currently unavailable or you lack permission to view this resource.</p>
